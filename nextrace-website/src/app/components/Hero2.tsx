  ...
  return (
    <div className="bg-gray-900 relative isolate overflow-hidden" >
      ...
      <div className="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40 ml-[7rem]" >
        ...
        className="rounded-full flex px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 border-4 border-solid border-indigo-500"
      >
