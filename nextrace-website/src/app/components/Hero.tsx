          ...
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              {/* <img
                ...
                alt=""
              /> */}
              <p className="text-3xl font-serif font-semibold leading-6 text-white">NexTrace</p>
            </a>
          </div>
